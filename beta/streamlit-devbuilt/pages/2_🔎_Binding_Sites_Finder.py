...
# TSS entry
entry_tis = st.number_input("🔸 :red[**Step 1.4**] Transcription Start Site (TSS) at (in bp):", 0, 10000, 0, help="Distance of TSS or gene end from begin of sequences.\nSame distance is required for multiple sequences.\nLeave 0 if you don't know")
